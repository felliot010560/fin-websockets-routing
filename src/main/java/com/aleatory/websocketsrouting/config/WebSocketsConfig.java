...
public class WebSocketsConfig implements WebSocketMessageBrokerConfigurer {
	...
	private static final String[] PRICE_DESTINATIONS = new String[] { "/topic/prices.current.condor",
			"/topic/prices.condor", "/topic/prices.spx", "/topic/prices.impvol" };
	...
	@Bean
	@ConditionalOnProperty(value = "backend.messaging.transport", havingValue = "websockets", matchIfMissing = false)
	public WebSocketStompClient pricingStompClient(
			@Qualifier("priceHandler") WebsocketsBackendMessagingClient handler) {
	...
	private static final String[] TRADING_DESTINATIONS = new String[] { "/topic/trading.state",
			"/topic/trading/condor.bid", "/topic/trading.time" };
	...
	@Bean
	@ConditionalOnProperty(value = "backend.messaging.transport", havingValue = "websockets", matchIfMissing = false)
	public WebSocketStompClient tradingStompClient(
			@Qualifier("tradingHandler") WebsocketsBackendMessagingClient handler) {
		WebSocketClient client = new StandardWebSocketClient();
	...
	@Bean
	@ConditionalOnProperty(value = "backend.messaging.transport", havingValue = "websockets", matchIfMissing = false)
	public WebSocketStompClient portfolioStompClient(
			@Qualifier("portfolioHandler") WebsocketsBackendMessagingClient handler) {
		WebSocketClient client = new StandardWebSocketClient();
